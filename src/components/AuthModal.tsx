          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-xs text-gray-200 mt-1 max-w-xs leading-relaxed">
              {currentUser 
                ...
                : 'Sign in with your Google account to access 3D printing, custom quotes, and daily spin rewards.'}
            </p>
          </div>
        </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <h3 className="font-bold text-gray-900 text-base truncate">
                      {currentUser.role === 'vip' ? 'VIP Member' : (currentUser.displayName || 'Google Member')}
                    </h3>
                    {currentUser.role === 'vip' ? (
                  ...
                  <p className="text-xs text-gray-500 truncate mt-0.5 font-medium">
                    {currentUser.role === 'vip' ? 'VIP Passcode Authorized' : (currentUser.email || 'Google Account Connected')}
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-blue-50/80 border border-blue-200/90 rounded-2xl text-left">
                    ...
                    <p className="text-[11px] text-blue-800 leading-relaxed">
                      Sign in securely with your Google account. Your orders and custom designs are protected and synced in real-time.
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full py-3.5 px-4 bg-white hover:bg-gray-50 active:scale-99 text-gray-800 font-bold text-sm rounded-2xl border-2 border-gray-200 hover:border-gray-400 shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-3 cursor-pointer disabled:opacity-50"
                  >
                    {loading ? (
                  ...
                  <div className="relative flex py-1 items-center">
                    ...
                    <span className="shrink mx-3 text-gray-400 text-[10px] uppercase font-bold tracking-wider">
                      Or Sign In with Google Email
                    </span>
                    <div className="grow border-t border-gray-200"></div>
                  </div>

                  {/* Direct Email Sign In form for cross-origin sandbox compatibility */}
                  <form 
                    onSubmit={(e) => {
                      e.preventDefault();
                  ...
                  >
                    <div>
                      <input
                        ...
                        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-xs sm:text-sm font-semibold text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-[#af101a] focus:ring-1 focus:ring-[#af101a] outline-hidden transition-all"
                      />
                    </div>
                    <button
                      type="submit"
                      disabled={loading || !googleEmailInput.trim()}
                      className="w-full py-2.5 px-4 bg-gray-900 hover:bg-black active:scale-98 text-white font-bold text-xs rounded-xl shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-40"
                    >
